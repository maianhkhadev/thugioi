  ...
  return (
    <section className={styles.section} style={{ fontSize }}>
      <header className={styles.header}>
        <Title level={3}>Chương 1: Trở về quá khứ (1)</Title>
      </header>

      <main className={styles.content}>
        <p id="2">Maple World là thế giới của mạo hiểm giả.</p>
        <p id="3">
          Đó là một thế giới mà không thể vận hành được nếu thiếu mạo hiểm giả.
        </p>
        <p id="4">
        ...
        <p id="6">
          “Bên trong Mystic Gate, có rất nhiều quái vật. Không chỉ những con đến
          từ Maple World, mà còn cả những quái vật chưa từng được thấy trước
          đây.”
        </p>
        <p id="7">
        ...
        <p id="13">
          “Ngày xưa phải leo núi, vượt biển, xẻ trời mới có được một cuộc phiêu
          lưu đáng nhớ. Nhưng bây giờ, ta có thể tìm thấy Cổng thần bí xuất hiện
          ở sân sau nhà và có một cuộc phiêu lưu thậm chí còn thú vị hơn.”
        </p>
        <p id="14">
          Từ đó kỷ nguyên của Mystic Gate bắt đầu, một kỷ nguyên được các mạo
          hiểm giả ca ngợi là kỷ nguyên vĩ đại nhất trong lịch sử, kỷ nguyên của
          những giấc mơ.
        </p>
        <p id="15">
        ...
        <p id="17">
          Một thanh niên hai mươi tuổi đang làm những công việc lặt vặt ở thành
          phố cảng Liss đã bị mất việc chỉ sau một đêm.
        </p>
        <p id="18">
        ...
        <p id="20">
          “Đây là Cái chết đen. Một căn bệnh giết chết người bằng cách khiến họ
          ho ra máu đen. Đó là căn bệnh mà cha ngươi đã mắc phải.”
        </p>
        <p id="21">
          Tuy nhiên, cuộc sống của một chàng trai trẻ với một gia đình đang dần
          chết đi lại rất khác biệt.
        </p>
        <p id="22">
        ...
        <p id="24">
          Nhưng không có cách nào để một thanh niên không có việc làm như El Pam
          có thể có được 1 triệu meso.
        </p>
        <p id="25">
        ...
        <p id="27">
          “Kể từ bây giờ, ngươi là nô lệ của tầng lớp thượng lưu Gafor theo hợp
          đồng.”
        </p>
        ...
        <p id="33">Tuy nhiên, El Pam vẫn sống sót hết lần này đến lần khác.</p>
        ...
        <p id="39">
          Đó là cách El Pam sống trước khi một chiếc vòng đen bất ngờ xuất hiện
          trên cổ tay trái của cậu.
        </p>
        <p id="40">
          Chiếc vòng đầu tiên, điều kiện tiên quyết để trở thành 1 mạo hiểm giả,
          đã được mở khóa.
        </p>
        <p id="41">
        ...
        <p id="46">
          Chỉ sau ba năm thức tỉnh với tư cách là một nhà thám hiểm, cậu lần đầu
          tiên được đối xử như một con người.
        </p>
        ...
        <p id="54">
          Cậu không còn cách nào khác ngoài sử dụng Thunderbolt để cứu nguy cho
          đồng đội.
        </p>
        <p id="55">Nó thật điên rồ.</p>
        <p id="56">“Cậu là một pháp sư thuộc tính lửa phải không?”</p>
        <p id="57">
          Sử dụng phép thuật có thuộc tính khác với thuộc tính bẩm sinh của một
          người không khác gì một cái cây đang đùa với lửa. Đó là một hành động
          gây sát thương khủng khiếp cho cơ thể của người thi triển.
        </p>
        <p id="58">
        ...
        <p id="61">
          Tuy nhiên, cơ thể của El Pam hoàn toàn không hề hấn gì khiến quyết tâm
          của cậu dường như đổ sông đổ biển.
        </p>
        <p id="62">“Có lẽ nào cậu ấy sinh ra đã có hai thuộc tính?”</p>
        <p id="63">
          Tất nhiên, cho đến thời điểm đó, tất cả mọi người, kể cả chính El Pam,
          đều cho rằng cậu vừa sinh ra đã có hai thuộc tính.
        </p>
        <p id="64">“Điều đó không tuyệt vời sao?”</p>
        <p id="65">Bởi vì đó cũng là một vấn đề lớn.</p>
        <p id="66">
          “Chết tiệt, lũ nấm đang tới! Lũ nấm zombie chết tiệt đó đang đến! Mọi
        ...
        <p id="68">
          Phải một thời gian sau cậu mới có thể phát huy hết kĩ năng All-Master
          của mình.
        </p>
        ...
        <p id="70">
          ...
          khăn giữa làn sương mù độc hại phun trào không ngừng, cậu mới nhận ra
          điều đó.
        </p>
        ...
        <p id="74">Là một All-Master, cậu trở thành một pháp sư quyền năng.</p>
        <p id="75">
          Infinite Magician, Shadow Butterfly Hunter, Balrog Slayer… vô số danh
          hiệu tô điểm lên cho tên tuổi của cậu.
        </p>
        ...
        <p id="78">
          Những ngày tháng phải liều mạng sống sót không những không thay đổi mà
          còn trở nên tồi tệ hơn.
        </p>
        <p id="79">
          Và cuối cùng, tất cả những gì còn lại sau khi sống sót quá những trận
          chiến khốc liệt chỉ là những danh hiệu mới.
        </p>
        ...
        <p id="89">
          Horntail là một con rồng sẽ không chết trừ khi cả ba cái đầu của nó bị
          cắt đi.
        </p>
        <p id="90">
        ...
        <p id="100">
          Horntail, cậu sẽ chuẩn bị để làm cho tất cả những cái đầu của con quái
          vật đó rơi xuống đất và thêm danh hiệu mới vào bộ sưu tập của mình:
          Horntail Slayer.
        </p>
        <p id="101">Có thể hay không, nó không còn quan trọng nữa.</p>
        <p id="102">
          Cậu đang chiến đấu vì điều gì, cậu đang đấu tranh vì ai? Thời gian để
          thảo luận về những vấn đề như vậy đã trôi qua từ lâu rồi.
        </p>
        <p id="103">
          Một thời đại mà việc săn quái vật là cách duy nhất để sống sót.
        </p>
        <p id="104">
          El Pam, mạo hiểm giả cuối cùng của thời đại đó, đứng dậy khỏi mặt đất.
        </p>
        ...
        <p id="109">
          ‘Nếu ta có bộ sưu tập của Gerechter, thủ lĩnh của Cross Hunters… ta có
          thể củng cố hơn nữa chiến thuật của mình. Nếu vẫn chưa đủ, hãy đến
          Edelstein. Quân kháng chiến nói rằng họ đã giấu Polearm của Aran, một
          trong Sáu anh hùng, trong két sắt của căn cứ, vì vậy….’
        </p>
        <p id="110">Vào khoảnh khắc ấy.</p>
        <p id="111">Đôi chân đang di chuyển của El Pam đột nhiên bị kẹt lại.</p>
        ...
        <p id="125">Khi đến lúc chết, hầu hết con người đều suy sụp như vậy.</p>
        ...
        <p id="131">
          ...
          trắn trối của đồng đội mình, không có ai ở đây để lắng nghe những lời
          cuối cùng của cậu.
        </p>
        <p id="132">
        ...
        <p id="141">Bụp!</p>
        <p id="142">
          Khoảnh khắc El Pam ngẩng đầu lên, có thứ gì đó bay đến và đập mạnh vào
          má cậu.
        </p>
        <p id="143">“Đứng dậy ngay, thằng nhóc!”</p>
        <p id="144">
          El Pam chỉ đơn giản là ngạc nhiên nhìn chằm chằm vào người đã tát
          mình, đôi mắt mở to vì sốc trước hành động bất ngờ đầy thô tục và bạo
          lực .
        </p>
        <p id="145">
        ...
        <p id="151">Khuôn mặt của El Pam mất đi biểu cảm với đôi mắt lờ đờ.</p>
        ...
        <p id="155">
          'Đây có phải một đoạn hồi tưởng? Tại sao nó lại đau đớn và rõ ràng đến
          vậy?’
        </p>
        <p id="156">Nhưng những gì cậu đang cảm thấy bây giờ không hề mơ hồ.</p>
        ...
        <p id="161">
          Cùng với tiếng hét bất ngờ, ai đó đã dùng hết sức đá vào lưng El Pam.
        </p>
        <p id="162">Bụp!</p>
        <p id="163">
        ...
        <p id="170">
          Với El Pam, sự hiện diện của quái vật không khác gì việc nhìn thấy cây
          cối trong rừng, đó chỉ là một phần trong cuộc sống thường ngày của cậu
          mà thôi.
        </p>
        <p id="171">'Rõ ràng.'</p>
        <p id="172">
        ...
        <p id="176">
          ‘Ngày tôi, một nô lệ bị dùng làm mồi nhử, đã mở vòng tròn đầu tiên của
          mình.’
        </p>
        ...
        <p id="179">Bởi vì đây là ngày mạo hiểm giả cuối cùng được sinh ra.</p>
